...
<div id="bgIMAGE">
	<img id="IMAGE" src="file/enrollment.png"/>
</div>
...
<div id="header" style="margin-top:-2px;">	
    	<ul>
        	<li><a href="Home"><img src="icon/home2.png" style="width:100px;"/></a></li>
            <li><a href="StudentRecord"><img src="icon/student.png" style="width:130px;margin-top:-5px;"/></a></li>
           
            <li><a href="drop_subject"><img src="icon/delete1.png" style="width:150px;"/></a> </l>
            
            <li><a href="#"><img src="icon/report.png" style="width:100px;"/></a>
				 <ul>
            ...
            <li><a href="#"><img src="icon/setting.png" style="width:100px;"/></a>
                <ul>
   ...
   <div style="background-color:;height:45px;margin-left:-52px;margin-right:-52px;margin-top:-48px;">
			<a href="#" style="margin-top:0px;margin-left:1260px;position:absolute;font-size:20px;text-decoration:none;color:white;" class="pull-right" data-toggle="modal" data-target="#myModal"><img src="icon/logout.png" style="width:140px;"/></a>
			<p style="float:right;color:white;margin-top:5px;margin-right:30px;font-size:30px; background-color: black;border-radius:5px;">
			<?php
